...
public class TrackingService
{
   ...
   public List<TrackingInfo> get_all_list(int id){
      List<TrackingInfo> list_by_name = new ArrayList<TrackingInfo>();
      for (TrackingInfo trackinginfo: trackingList) {
         if(trackinginfo.trackableId == id)
            list_by_name.add(trackinginfo);
      }
      return list_by_name;
   }

   public List<TrackingInfo> get_all_data(){
      return trackingList;
   }
